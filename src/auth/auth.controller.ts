import { Controller, Post, Patch, Body, HttpCode, HttpStatus, Param, ParseIntPipe } from '@nestjs/common';
...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Reset token generated (sent via email in production)', type: MessageResponseDto })
  @ApiResponse({ status: 400, description: 'Validation failed' })
