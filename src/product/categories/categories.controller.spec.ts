...
const mockCategory = { id: 1, name: 'Raw Dried Herbs', slug: 'raw-dried-herbs', parentId: null, createdAt: new Date() };
...
describe('CategoriesController', () => {
  ...
  describe('create', () => {
    it('should create and return a category', async () => {
      const dto: CreateCategoryDto = { name: 'Raw Dried Herbs', slug: 'raw-dried-herbs' };
  ...
  describe('update', () => {
    it('should update and return the category', async () => {
      ...
      service.update.mockResolvedValue({ ...mockCategory, name: 'Updated Herbs' });
  ...
  describe('remove', () => {
    it('should delete a category and return success message', async () => {
      service.remove.mockResolvedValue({ message: 'Category deleted successfully' });
