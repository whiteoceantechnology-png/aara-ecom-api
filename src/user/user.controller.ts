...
export class UserController {
  ...
  async getProfile(@Param('id', ParseIntPipe) id: number): Promise<UserProfileResponseDto> {
  ...
  @ApiParam({ name: 'id', type: Number, description: 'User ID' })
  @ApiResponse({ status: 200, description: 'List of user addresses', type: [AddressResponseDto] })
  async getAddresses(@Param('id', ParseIntPipe) id: number): Promise<AddressResponseDto[]> {
